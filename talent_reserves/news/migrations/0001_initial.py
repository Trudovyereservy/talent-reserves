    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='news.commontag')),
            ],
            options={
                'verbose_name': 'tagnews',
                'verbose_name_plural': 'tagnews',
            },
        ),
        migrations.AddField(
            model_name='news',
            name='tags',
            field=models.ManyToManyField(through='news.TagNews', to='news.commontag'),
        ),
        migrations.CreateModel(
            name='ContentNews',
            fields=[
