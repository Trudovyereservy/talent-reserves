...
const buttonsNames: ButtonNames = {
  ...
  mainButtonFooter: 'Подать заявку',
};

const headerLinks: HeaderLink[] = [
  { id: 0, title: 'Блог', href: '/blog' },
  { id: 1, title: 'Тренерский состав', href: '/coaches' },
...
const navLinksMenu: NavLink[] = [
  ...
  { id: 3, name: 'Тренерский состав', href: '/coaches' },
...
const testFaqItems = [
  {
    title: 'Трудовые резервы – это спортивная секция?',
    text:
      'В трудовые резервы входят спортивные секции. Трудовые резервы это фонд, формирующий здоровые кадры формируются из спортсменов для промышленности. Фонд объединят федерации, фонд заботятся о профориентации закончивших карьеру спортсменов.  Резервы заботятся о профориентации и помогают найти призвание и дело по душе всем занимающимся.',
    id: 0,
  },
  {
    title: 'С какого возраста можно заниматься?',
    text:
      'Трудовые резервы принимают детей от 7 лет при наличии устойчивых текущих спортивных достижений.',
    id: 1,
  },
  {
    title: 'Как попасть в трудовые резервы?',
    text:
      'Записался в секцию , попал в федерацию, федерация в трудовых резервах. В приоритетном порядке предложения поступают членам сборных, показывающих устойчивые спортивные результаты.',
    id: 2,
  },
  {
    title: 'Кем я буду после выпуска из трудовых резервов?',
    text:
    'Согласно статистике из сборной 1-2 спортсмена строят профессиональную спортивную карьеру, 1-2 становятся тренерами, а остальные уходят из спорта. Трудовые резервы помогают не только добится спортивной карьеры, но и найти себя тем, кто решил не идти в профессиональный спорт. Экскурсии, профориентации, профессиональные комьюнити разных отраслей и знакомство с разными предприятиями своего края помогут выпускнику точно найти себя в любой области. А развитые мягкие навыки помогут быстро достичь в выбранной области успехов. ',
  id: 3,
  },
];
...
const testCards = [
  {
    title: 'Трудовые резервы открылись',
    subtitle: '',
    text: '',
    linkUrl: '#',
    linkText: 'Пример текста',
  ...
  {
    title: 'Планируется открытие трудовых резервов в нытве и чернушке',
    subtitle: '',
    text: '',
    linkUrl: '#',
    linkText: 'Пример текста',
  ...
  {
    title: 'Секции Киокушинкай работают в Перми',
    subtitle: '',
    text: '',
    linkUrl: '#',
    linkText: 'Пример текста',
...
const cardsCompanyInfo: CardCompanyInfo[] = [
  {
    subtitle: 'Спортивная подготовка',
    textItem: 'Спортивные секции предлагают детям полноценную физическую подготовку в соответствии с выбранным видом спорта. Дети, которые серьезно занимаются спортом и имеют амбиции участвовать в соревнованиях, присоединяются к отдельной группе, где они будут подготавливаться к участию в соревнованиях.',
    id: 1,
  },
  {
    subtitle: 'Культура здорового образа жизни',
    textItem: 'Формируем полезные привычки, влияющие на жизнь вне секции. Режим сна, правильное питание, поддержание физической формы, соблюдение спортивной этики.',
    id: 2,
  },
  {
    subtitle: 'Профориентация',
    textItem: 'Мы заинтересованы в успешной будущем наших выпускников. Для этого среди учащихся проводим профориентационные мероприятия, экскурсии на предприятия города, встречи с известными людьми в науке, промышленности, бизнесе и спорте.',
    id: 3,
  },
  {
    subtitle: 'Лидерство',
    textItem: 'Через спорт и внутреннюю культуру мы воспитываем людей, способных принимать решения и нести ответственность за свою жизнь. А умение брать ответственность позволяет изменить мир вокруг нас.',
    id: 4,
  },
  {
    subtitle: 'Конкурсная основа',
    textItem: 'Зачисление в трудовые резервы проходит на конкурсной основе, согласно спортивным достижениям.  Мы стремимся привлечь тех, кто уже продемонстрировал свои спортивные способности и готов продолжать развиваться и прогрессировать.',
    id: 5,
  },
];
